...
macro_rules! __export_world_rust_template_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        ...
        $($path_to_types)*:: _export_ping_cabi::<$ty > (arg0, arg1) } };
    };
}
#[doc(hidden)]
...
\x04\0%component:rust-template/rust-template\x04\0\x0b\x13\x01\0\x0drust-templat\
e\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.220.1\x10\
